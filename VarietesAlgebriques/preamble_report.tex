...
\newtcolorbox{theorem}[2][]{
    ...
    title=Théorème~\stepcounter{COUNTER}\theCOUNTER\ifstrempty{#2}{}{:~#2},
...
\newtheorem{corollary}[COUNTER]{Corollaire}
...
\newtcolorbox{eser}[2][]{
    ...
    title={Exercise~\stepcounter{COUNTER}\theCOUNTER~#2}, % Title format
    sharp corners, % Less rounded corners
