...
\newenvironment{theorem}[1][]{
    ...
    {\mdfsetup{
        frametitle={
            ...
            {\strut Teorema~\thecounter};}
        }
    }{\mdfsetup{
        frametitle={
            \tikz[baseline=(current bounding box.east),outer sep=0pt]
            \node[anchor=east,rectangle,fill=blue!20,rounded corners=5pt]
            {\strut Teorema~\thecounter~#1};}
        }
    }
    \mdfsetup{
        roundcorner=10pt,
...
\newtcolorbox[auto counter, number within=section]{definition}[2][]{
    ...
    title={Definizione~\thecounter\ifstrempty{#2}{}{:~#2}}, % Title format
...
\newenvironment{lemmao}[1][]{
    ...
    {\mdfsetup{
        frametitle={
            ...
            {\strut Lemma~\thecounter};}
        }
    }{\mdfsetup{
        frametitle={
            \tikz[baseline=(current bounding box.east),outer sep=0pt]
            \node[anchor=east,rectangle,fill=green!20,rounded corners=5pt]
            {\strut Lemma~\thecounter~#1};}
        }
    }
    \mdfsetup{
        roundcorner=10pt,
...
\newtheorem{corollary}{Corollario}[COUNTER]
...
\newtcolorbox[auto counter, number within=section]{eser}[1][]{
    ...
    title={Esercizio~\thecounter~#1}, % Title format
    sharp corners, % Less rounded corners
